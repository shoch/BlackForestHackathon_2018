...
contract ShareTicket{
    ...
    function PassOnTicket(address TicketUserCurrentUser, uint TicketUserTimestampPassed, uint GeoLocationLatPassed, uint GeoLocationLongPassed) public{
        ...
        {
            m_Ticket.TicketUsers[m_Ticket.TickertUserCount-1].TicketUserTimestampPassed = TicketUserTimestampPassed;
            m_Ticket.TicketUsers[m_Ticket.TickertUserCount-1].GeoLocationLatPassed = GeoLocationLatPassed;
            m_Ticket.TicketUsers[m_Ticket.TickertUserCount-1].GeoLocationLongPassed = GeoLocationLongPassed;
    ...
    function GetTicketCurrentUser() public view returns(address){
        ...
        return m_Ticket.TicketUsers[m_Ticket.TickertUserCount-1].TicketUserCurrentUser;
    }
    ...
    function GetTicketLastGeoLocation() public view returns(uint,uint){
        ...
        return (m_Ticket.TicketUsers[m_Ticket.TickertUserCount-1].GeoLocationLatRecived, m_Ticket.TicketUsers[m_Ticket.TickertUserCount-1].GeoLocationLongRecived);
    }
